...
We also verified CacheInf's performance on a broader range of visual models common to mobile devices: DenseNet~\cite{huang2018densely}, VGGNet~\cite{simonyan2015deep}, ConvNeXt~\cite{woo2023convnext}, RegNet~\cite{xu2022regnet}, and we used their default implementation of torchvision~\cite{noauthor_torchvision_nodate}. 
...
\begin{figure}[!t]
    \centering
    \subfloat[Targeted people]{\includegraphics[width=0.48\linewidth]{fig/people.drawio.png}}
    \hfil
    \subfloat[Robot moving trajectory]{\includegraphics[width=0.48\linewidth]{fig/robot.drawio.png}}
