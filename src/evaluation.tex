...
\begin{figure}[!t]
    %\vspace{-0.3cm}
    \centering
    \subfloat[Targeted people]{\includegraphics[width=0.7\linewidth]{fig/people.drawio.png}}

    %\vspace{-0.3cm}
    \subfloat[Robot moving trajectory]{\includegraphics[width=0.7\linewidth]{fig/robot.drawio.png}}
    %\vspace{-0.4cm}
...
\begin{figure}[!t]
    ...
    %\vspace{-0.3cm}
    \centering
    \subfloat[Indoors]{\includegraphics[width=0.7\linewidth]{fig/agrnav.png}}

    %\vspace{-0.3cm}
    \subfloat[Outdoors]{\includegraphics[width=0.7\linewidth]{fig/agr_outdoors.png}}
