...
\begin{figure}[!t]
    \centering
    \subfloat[Four-wheeled robot]{\includegraphics[width=0.48\linewidth]{fig/robot.png}}
    \hfil
    \subfloat[Air-ground robot]{\includegraphics[width=0.48\linewidth]{fig/agr_robot.png}}
