...
\begin{figure}[htp]
    \centering
    \subfloat[Indoors\label{fig:indoors}]{\includegraphics[width=0.5\linewidth]{fig/indoors_01.png}}
    \subfloat[Outdoors\label{fig:outdoors}]{\includegraphics[width=0.5\linewidth]{fig/outdoors_01.png}}
