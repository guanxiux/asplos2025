...
In visual models, the computation results of local operators often consumes significantly more memory than the parameters of the local operators themselves and naively caching all the computation results leads to a heavy GPU memory burden.
...
Chapter five describes implementation.
